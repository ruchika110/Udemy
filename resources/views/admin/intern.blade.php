...
<!-- Content Wrapper. Contains page content -->
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a class="btn btn-success btn-sm" href="" data-toggle="modal" data-target="#exampleModal">Add Intern</a>
</div>
              </div>
              <div class="card-body">
                ...
                @foreach($i_show as $key=>$d)
                    ...
                    <tr class="text-center">
                      ...
                      <td scope="col">
                          ...
                          <a href="{{url('admin/intern_edit/'.$d->id)}}"><input class="btn btn-success" type="submit" name="edit" value="Edit" style="width: 70px;"></a><br><br>
                          <a href="{{url('admin/intern_delete/'.$d->id)}}"><input class="btn btn-danger" type="submit" name="delete" value="Delete"></a>
 ...
 <span aria-hidden="true">&times;</span>
  ...
  @endif
        ...
        <form  method="post" action="{{url('admin/i_save')}}" enctype="multipart/form-data">
