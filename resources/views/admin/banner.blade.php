            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a class="btn btn-success btn-sm" href="" data-toggle="modal" data-target="#exampleModal">Add Banner</a>
</div>
              </div>
              <div class="card-body">
                 ...
                 @foreach($display as $key=>$d)
                    ...
                    <tr class="text-center">
                      ...
                      <td scope="col">
                          ...
                          <a href="{{url('admin/banner_edit/'.$d->id)}}"><input class="btn btn-success" type="submit" name="edit" value="Edit" style="width: 70px;"></a><br><br>
                          <a href="{{url('admin/banner/delete/'.$d->id)}}"><input class="btn btn-danger" type="submit" name="delete" value="Delete"></a>
